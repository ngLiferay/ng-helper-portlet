 ...
 * @generated
 */
public class NGServicesServiceClp implements NGServicesService {
    ...
    public NGServicesServiceClp(InvokableService invokableService) {
        ...
        _methodName3 = "getMethodNamesAndParams";

        _methodParameterTypes3 = new String[] {  };

        _methodName4 = "getContextServices";
    ...
    public com.liferay.portal.kernel.json.JSONObject getContextServices(
        ...
        try {
            returnObj = _invokableService.invokeMethod(_methodName4,
                    ...
                    ClpSerializer.translateInput(services)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
